                        ...
                        <tbody>
                            <?php 
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        <td>
                                            <div class="tooltip">'.substr($name,0,25).'
                                        ...
                                        <td>
                                            <div class="tooltip">'.substr($email,0,25).'
                                        ...
                                        <div style="display:flex; justify-content: center; gap: 10px;">
                                            <a href="?action=view&id='.$pid.'" class="non-style-link">
                                                <button class="btn-primary-soft btn button-icon btn-view" style="padding: 10px 34px; margin-top: 10px;">&nbsp;
                                                    <font class="tn-in-text" style="margin-right:0;">View</font>
                                                </button>
                                            </a>
                                            <a href="?action=drop&id='.$pid.'&name='.$name.'" class="non-style-link">
                                                <button class="btn-primary-soft btn button-icon btn-delete" style="padding: 10px 34px; margin-top: 10px;">&nbsp;
                ...
                <div id="popup1" class="overlay">
                    <div class="popup">
                        <center>
                            ...
                            <a class="close" href="patient.php">&times;</a>
                            <div class="content">
                                You want to delete this patient record:<br>(' . substr($name, 0, 40) . ')              
                            </div>
                            <div style="display: flex; justify-content: center;">
