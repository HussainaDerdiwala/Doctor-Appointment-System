            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                    ...
                    <td width="15%">
                        ...
                        <p class="heading-sub12" style="padding: 0;margin: 0;">
                            <?php 
                                ...
                                $today = date('Y-m-d');
                                echo $today;
                                $list110 = $database->query("SELECT * FROM schedule WHERE scheduledate >= CURDATE()");
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Active Sessions (<?php echo $list110->num_rows; ?>)</p>
                    </td>
                </tr>
                <tr>
                            ...
                            <?php 
                                ...
                                if($result->num_rows==0){
                                    ...
                                    for ($x = 0; $x < $result->num_rows; $x++) {
                                        ...
                                        // compute expired status safely using strtotime
                                        $isExpired = (strtotime($scheduledate) < strtotime(date('Y-m-d')));
                                        ?>
                                        <tr>
                                            <td>&nbsp;<?php echo substr($title, 0, 30); ?></td>
                                            <td>
                                                <div class="tooltip"><?php echo substr($docname, 0, 20); ?>
                                                    <span class="tooltiptext"><?php echo $docname; ?></span>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div style="display:flex;justify-content: center;">
                                                    <!-- View button -->
                                                    <a href="?action=view&id=<?php echo $scheduleid; ?>" class="non-style-link">
                                                    ...
                                                    <!-- Expired OR Remove button -->
                                                    <?php if ($isExpired) { ?>
    <button class="btn-primary-soft btn button-icon" disabled
            style="padding-left: 40px; padding-top: 12px; padding-bottom: 12px; margin-top: 10px; display:flex; align-items:center; gap:6px; cursor:not-allowed; opacity:0.7;">
        <!-- Invisible SVG to reserve same space as icons in View/Remove -->
...
<?php } else { ?>
                                                    ...
                                                    <a href="?action=drop&id=<?php echo $scheduleid; ?>&name=<?php echo urlencode($title); ?>"
                                                        class="non-style-link">
                                                            <button class="btn-primary-soft btn button-icon btn-delete"
                                                                    style="padding-left: 40px;padding-top: 12px;
