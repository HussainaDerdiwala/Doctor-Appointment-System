                        ...
                        <tbody>
                            <?php 
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                    <td>&nbsp;
                                        <div class="tooltip">'.substr($pname,0,35).'
                                            <span class="tooltiptext">'.$pname.'</span>
                                        </div>
                                    </td>
                                    ...
                                    <td>&nbsp;
                                        <div class="tooltip">'.substr($title,0,15).'
                                ...
                                if (strtotime($appodate) < strtotime($today)) {
                                    // Past appointment → Expired
                                    echo '<button class="btn-primary-soft btn button-icon" 
                                            style="padding-left:40px;
                                                   ...
                                                   opacity:0.6;
                                                   cursor:not-allowed;" 
                                            disabled><font class="tn-in-text">Expired</font></button>';
                                } else {
                                    // Today or future → Cancel
                                    echo '<a href="?action=drop&id='.$appoid.'&name='.urlencode($pname).'&session='.urlencode($title).'&apponum='.$apponum.'" 
