                            ...
                            <?php 
                                ...
                                if($result->num_rows==0){
                                    ...
                                    for ($x=0; $x<$result->num_rows;$x++){
                                        ...
                                        $sessionDateTime = strtotime($scheduledate . " " . $scheduletime);
                                        $now = time();
                                        ...
                                        echo '<tr>
                                            <td>
                                                <div class="tooltip">'.substr($title,0,20).'
                                        ...
                                        if($isPast){
                                            ...
                                            echo '<button class="btn-primary-soft btn button-icon btn-delete" disabled 
                                                    style="opacity:0.5;cursor:not-allowed;padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;">
                                                    <font class="tn-in-text">Cancel Session</font>
                                                  </button>';
                                        } else {
                                            // active cancel button
                                            echo '<a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="non-style-link">
