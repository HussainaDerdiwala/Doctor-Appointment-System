                                            ...
                                            <td style="width: 25%;">
                                                <div class="dashboard-items search-items">        
                                                    <div style="width:100%;">
                                                        ...
                                                        // ✅ Show Cancel button only for today/future dates
                                                        if ($scheduledate >= $today) {
                                                            ...
                                                            // Past date → disabled button
                                                            echo '
                                                            <button class="login-btn btn-primary-soft btn"  
                                                                style="padding-top:11px;padding-bottom:11px;width:100%;opacity:0.6;cursor:not-allowed;" 
                                                                disabled>
                                                                <font class="tn-in-text">Cancel Booking</font>
                                                            </button>';
                                                        }
